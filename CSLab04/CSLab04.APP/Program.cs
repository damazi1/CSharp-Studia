...
namespace lab04
{
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("===== Wypisanie organizacji NR_1 =====");
            Console.WriteLine(organizationUnit1);
            Console.WriteLine("\n===== Wypisanie organizacji NR_2 =====");
            ...
            Console.WriteLine("\n===== Wypisanie Wydziału NR_2 =====");
            department2.Print();

            var obtainedStudent = department2.Get<Student>(x => x.Group == 1);
            Console.WriteLine("\n===== Wypisanie Studenta NR_1 =====");
            obtainedStudent.Print();
            //Nie wiem co ma zwracac student ?!
            Console.WriteLine("\n===== Wypisanie Znalezionych danych NR_1 =====");
            department2.Get<Student>()
                .GetList<FinalGrade>(g => g.Subject.Specialization == "Informatyka")
                .Print();
            ...
            Console.WriteLine("\n===== Wypisanie Znalezionej organizacji NR_1 =====");
            ...
            Console.WriteLine("\n===== Wypisanie Znalezionej Organizcji NR_2 =====");
            organizationUnit.Print();

            department2.Get<OrganizationUnit>(x => x.Name == "SKL")
                .Remove<Lecturer>(l => l.FirstName == "Maria");
            Console.WriteLine("\n===== Wypisanie Departamentu po usunięciu NR_1 =====");
            department2.GetList<OrganizationUnit>(ou => ou.Name == "SKL")
                .Print();

            Console.WriteLine("\n\nPYTANIE: W jaki sposób należy używać funkcji ForEach z klasy CrudActionExtensions \n" +
                "w jaki sposób ma działać polecenie Get (chodzi o fragment z linii 84) ");
        }
    }
